...
def gradient_descent(points, starting_b, starting_m, learningrate, num_iterations):
    b = starting_b
    m = starting_m
...
def run():
    ...
    print("Running...")
    [b,m] = gradient_descent(points, initial_b, initial_m, learningrate, num_iterations) 
